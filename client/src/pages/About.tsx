  ...
  return (
    <div className="page inner-page about-page">
      ...
      <section className="about-story">
        <div className="about-pullquote"><Quote size={24} /><p>Presentation should be the bridge between how good you are and how good you look online.</p><span>— Amplify Studio</span></div>
      ...
      <section className="about-cta">
        <div><p className="eyebrow">Let’s make your next move count</p><h2>Ready to sound<br /><em>louder?</em></h2></div>
        <a className="button button-primary" href={whatsappUrl()} target="_blank" rel="noreferrer"><MessageCircle size={17} /> Talk to us <ArrowUpRight size={16} /></a>
      </section>
    </div>
  );
}
